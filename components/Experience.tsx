...
const Experience: React.FC = () => {
  return (
    <section id="experience" className="bg-gray-50 py-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <motion.h2
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="text-4xl md:text-6xl font-semibold tracking-tight text-gray-900 mb-16 text-center"
        >
          Journey
        </motion.h2>
            ...
            <div className="space-y-8">
              {EXPERIENCE.map((exp, i) => (
                <motion.a
                  ...
                  whileHover={{ y: -5 }}
                  className="block bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-lg hover:border-blue-300 transition-all duration-300 group cursor-pointer"
                >
